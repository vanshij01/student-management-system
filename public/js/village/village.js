...
function dataTableData() {
    var dataTable = $('#village_table').DataTable({
        searching: true,
        processing: true,
        serverSide: true,
        scrollX: true,
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (updateCheck) {
                        $html += '<li><a class="dropdown-item dropdown-trigger-17500btn waves-effect edit_button" href="village/' + data + '/edit">Edit</a></li>';
                    }
                    if (readCheck) {
                        $html += '<li><a class="dropdown-item dropdown-trigger-17500btn waves-effect view_button" href="village/' + data + '">View</a></li>';
                    }
                    if (isSuperAdmin != 0) {
...
$(".village_form").parsley();

$("#village_create_form").submit(function (event) {
...
function deleteCourse(id) {
    var url = "village/delete/" + id;
    var tableId = 'village_table';
