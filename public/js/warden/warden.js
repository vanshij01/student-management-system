...
function dataTableData() {
    ...
    var dataTable = $('#warden_table').DataTable({
        searching: true,
        processing: true,
        serverSide: true,
        scrollX: true,
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    if (updateCheck) {
                        $html += '<li><a class="dropdown-item dropdown-trigger-17500btn waves-effect" href="warden/' + data + '/edit">Edit</a></li>';
                    }
                    if (readCheck) {
                        $html += '<li><a class="dropdown-item dropdown-trigger-17500btn waves-effect" href="warden/' + data + '">View</a></li>';
                    }
                    if (isSuperAdmin != 0) {
                        $html += '<li><a class="dropdown-item dropdown-trigger-17500btn waves-effect" href="javascript:void(0)" data-id="' + data + '" onclick="deleteWarden(' + data + ')">Delete</a></li>';
                    }
...
$('.edit').on('click', function () {
    var id = $(this).data('id');
    location.href = "/warden/" + id + "/edit";
});

$("#warden_create_form").submit(function (event) {
...
function deleteWarden(id) {
    var url = "warden/delete/" + id;
    var tableId = 'warden_table';
