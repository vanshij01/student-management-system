...
<body bgcolor="#f2f2f2" style="margin: 0px;" width="100%">
    <center style="background: #f2f2f2; width: 100%; text-align: left;"><!-- Preheader : BEGIN -->
        <table align="center" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" class="email-container"
            ...
            <tbody>
                <tr>
                    <td align="center" dir="ltr" style="padding: 0; vertical-align: middle;" valign="middle"
                        width="100%">
                        <table align="center" aria-hidden="true" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                                <tr>
                                    <td align="left"
                                        style="padding: 10px 0 10px 10px; margin: 0; font-weight: normal; font-size: 10px ; color: #60605B; font-family: Helvetica, Arial, sans-serif; line-height: 12px; mso-line-height-rule: exactly; text-align: left;"
                                        valign="middle"><span>Just one more step.</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                            ...
                            <tbody>
                                <tr><!-- Column : BEGIN -->
                                    <td align="center" dir="ltr"
                                        ...
                                        valign="top"><a href="https://student.sklpsahmedabad.com/"><img
                                                alt="SKLPS Ahemdabad" aria-hidden="true" border="0" class="fluid"
                                        ...
                                        <table aria-hidden="true" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                                    ...
                                                                    <td align="left"
                                                                        ...
                                                                        @else
                                                                            <span>Hi,<br /><br />
                                                                                ...
                                                                                Shree
                                                                                Kutchi Leva Patel Samaj - Ahmedabad
                                                                                Student
                                                                                Portal. <br /><br />Just one more step.
                                                                                For
                                                                                security reasons, please click the
                                                                                button
                                                ...
                                                @isset($actionText)
                                                    <tr>
                                                        <td align="center"
                                                            style="color: rgb(96, 96, 91); line-height: 24px; font-family: Helvetica, Arial, sans-serif; font-size: 12px;">
                                                            <table align="center" aria-hidden="true" border="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="button-td"
                                                                            style="background: #ffb422; text-align: left;">
                                                                            <a class="button-a" href="{{ $actionUrl }}"
                                                                                target="_blank"
                                                                                style="background: #ffb422; border-radius: 3px; border: 15px solid #ffb422; border-left: 25px solid #ffb422; border-right: 25px solid #ffb422; text-align: center; line-height: 1.3; font-family: Helvetica, Arial, sans-serif; font-size: 16px; font-weight: normal; text-decoration: none; display: block;"><span
                                                                                    class="button-link"
                                                                                    style="color: rgb(255, 255, 255);">{{ $actionText }}</span>
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
        ...
        <tr>
            <td bgcolor="#ffffff" style="padding: 10px 30px 5px 30px; border-top: 5px solid #ffb422;">
               ...
               <tr><!-- Column : BEGIN -->
                  ...
                  <table align="center" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float: left;" width="100%">
                     <tbody>
                        <tr>
                           <td class="center-on-narrow" dir="ltr" style="text-align: left; font-weight: bold;color: #60605B; line-height: 20px; mso-line-height-rule: exactly; font-family:  Helvetica, Arial, sans-serif; font-size: 12px;" valign="top">STAY CONNECTED WITH US:</td>
                        </tr>
                     </tbody>
                  </table>
                  </td>
                  ...
                  <table aria-hidden="true" border="0" cellpadding="0" cellspacing="0" class="center-on-narrow" role="presentation">
                     <tbody>
                        <tr>
                                 ...
                                 <tr>
                                    <td style="width: 10px;">
                                      <a href="https://www.facebook.com/">
                                        <img alt="Facebook" title="Facebook" aria-hidden="true" border="0" class="fluid" src="{{asset('images/icon/facebook.png')}}"  width="30" height="30">
                                       </a>
                                    </td>
                                    <td style="width: 10px;">
                                      <a href="https://www.instagram.com/">
                                          <img alt="Instagram" title="Instagram" aria-hidden="true" border="0" class="fluid" src="{{asset('images/icon/instagram.png')}}"  width="30" height="30">
                                      </a>
                                    </td>
                                    <td class="hide-on-small" width="90" height="30" ></td>
                                 </tr>
                              </tbody>
                           </table>
                           </td>
                    ...
                    <tbody>
                        <tr>
                            <td align="left"
                                ...
                                <span><strong>Address:</strong> Saint Xavier's School Road, Opp. Kamnath Mahadev Temple,
                                    Naranpura, Ahmedabad - 380013</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="left"
                        ...
                        <tr>
                            <td align="left"
                                style="padding-top: 10px; font-weight: normal; font-size: 12px ; color:#60605B; font-family:  Helvetica, Arial, sans-serif; line-height: 24px; mso-line-height-rule: exactly;">
                                <span> © 2022 Shree Kutchi Leva Patel Samaj - Ahmedabad. All rights reserved.</span>
                            </td>
                        </tr>
                    </tbody>
                </table>
