...
<body bgcolor="#f2f2f2" style="margin: 0px;" width="100%">
    <center style="background: #f2f2f2; width: 100%; text-align: left;"><!-- Preheader : BEGIN -->
        <table align="center" aria-hidden="true" border="0" cellpadding="0" cellspacing="0" class="email-container"
            role="presentation" style="margin: auto; width: 640px; box-shadow: -1px 1px 10px 1px #b5d4e7;"
            width="640">
            <tbody>
                <!-- Header : BEGIN -->
                <tr>
                ...
                <tr>
                    <td align="center" style="padding: 0 px;" valign="top">
                                                                ...
                                                                <tr>
                                                                    <td align="center" style="padding: 0;"
                                                                        ...
                                                                        <table border="0" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td bgcolor="#ffffff"
                                                                                    style="padding: 30px; color: #60605B; font-family: Helvetica, Arial, sans-serif; font-size: 15px; line-height: 24px;">
                                                                                    <strong>Name:</strong>
                                                                                    {{ $studentData->first_name . ' ' . $studentData->last_name }}<br />
                                                                                    <strong>Hostel:</strong>
                                                                                    {{ $studentData->hostel_name }}<br />
                                                                                    <strong>Room No.:</strong>
                                                                                    {{ $studentData->room_number }}<br />
                                                    ...
                                                    <td style="vertical-align: middle;">
                                                        <table align="center" aria-hidden="true" border="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="width: 10px;">
                                                                        <a href="https://www.facebook.com/SKLPSabd">
                            ...
                            <tbody>
                                <tr>
                                    <td align="left"
                                        ...
                                        <p style="margin: 0"><strong>Address:</strong> Saint Xavier's School Road, Opp.
                                            Kamnath Mahadev
                                            Temple, Naranpura, Ahmedabad - 380013</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left"
                                        style="padding-top: 10px; font-weight: normal; font-size: 12px ; color:#60605B; font-family:  Helvetica, Arial, sans-serif; line-height: 24px; mso-line-height-rule: exactly;">
                                        <p style="margin: 0"><strong>Contact Info:</strong> M: +91 9099211718 | E-mail:
                                            student@sklpsahmedabad.com</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left"
                                        style="padding-top: 10px; font-weight: normal; font-size: 12px ; color:#60605B; font-family:  Helvetica, Arial, sans-serif; line-height: 24px; mso-line-height-rule: exactly;">
                                        <p style="margin: 0"> ©
                                            {{ date('Y') }} Shree Kutchi Leva Patel Samaj - Ahmedabad. All
                                            rights
                                            reserved.
                                        </p>
                                    </td>
