...
<body bgcolor="#f2f2f2" style="margin: 0px;" width="100%">
    <center style="background: #f2f2f2; width: 100%; text-align: left;">

        <table align="center" aria-hidden="true" border="0" cellpadding="0" cellspacing="0"
            class="email-container" role="presentation" style="margin: auto; width: 640px;" width="640">
            <tbody>
                <!-- Header : BEGIN -->
                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <span>Hi
                                                            {{ $roomAllomentDetail->student_name }},<br /><br />
                                                            Following room has been allotments you for the current year.
                                                            <br /><br />
                                                            <strong>Hostel Name:</strong>
                                                            {{ $roomAllomentDetail->hostel_name }} <br>
                                                            <strong>Room No:</strong>
                                                            {{ $roomAllomentDetail->room_number }} <br>
                                                            <strong>Bed No:</strong>
                                                            {{ $roomAllomentDetail->bed_number }} <br>
                                                        </span>
                                                    </td>
                                                </tr>
                                            </tbody>
