...
@section('content')
    <div class="card">
        <div class="card-header text-white py-3">
            <h5 class="card-title m-0 me-2 text-light">Add Leave</h5>
        </div>
        <form action="{{ route('leave.store') }}" method="post" id="leave_create_form" class="leave_form" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="subject" value="{{ old('subject') }}"
                            id="subject" placeholder="Enter title" required
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="leave_to" value="{{ old('leave_to') }}"
                            placeholder="DD/MM/YYYY" id="leave_to" autocomplete="off" required
