...
@section('content')
    <div class="dashboard-header-container">
        <div class="d-flex d-board-inr">
            ...
            <h3 class="dashboard-header">Roles</h3>
        </div>
        ...
        @php
            ...
            if ($chk) {
                echo "<a href='" . route('role.create') . "' class='btn primary_btn add_btn'>Add</a>";
            }
        @endphp
    ...
    <div class="table_content_wrapper">
        <div class="data_table_wrap">
            <table id="role_table" class="table table-bordered align-middle" style="width: 100%">
    ...
    <input type="hidden" id="readCheck" value="{{ \App\Models\Permission::checkCRUDPermissionToUser('Role', 'read') }}">
    <input type="hidden" id="updateCheck"
        value="{{ \App\Models\Permission::checkCRUDPermissionToUser('Role', 'update') }}">
@endsection
@section('scripts')
