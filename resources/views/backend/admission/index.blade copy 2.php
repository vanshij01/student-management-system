...
@section('content')
    ...
    <div class="table_content_wrapper">
        <div class="data_table_wrap">
            <div class="card-datatable table-responsive text-nowrap index-table-responsive pt-0">
                <div class="row page-wrapper">
                    <div class="col-md-2" id="admissionsTable_length">
                        <label {{-- style="display: flex; align-items: center; gap: 0.5rem; margin-bottom: 0;" --}}>
                            <select id="selPages" name="admissionsTable_length" aria-controls="admissionsTable">
                                ...
                                <td>
                                    ...
                                    <div class="row">
                                        <div class="col s12">
                                            <div class="dropdown">
                                                <button type="button"
                                                    class="btn btn-sm btn-warning p-1 dropdown-toggle hide-arrow text-white"
                ...
                <div class="row page-wrapper">
                    <div class="col col-md-12" id="admissionsTable_paginate">
                            ...
                            <div class="col-sm-12 col-lg-6 mb-4">
                                <div class="form-floating form-floating-outline">
                                    <select name="admission_status" id=""
                                        ...
                                        <option @if (old('admission_status') == '0') selected @endif value="0"
                                            selected>
                                            Pending
                                        </option>
