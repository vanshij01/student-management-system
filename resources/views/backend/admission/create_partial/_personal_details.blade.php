<div id="personal-details" class="content form-section">
        ...
        <div class="d-flex gap-3">
            <div class="form-check ps-0 m-0">
                <input class="form-check-input" type="radio" name="is_admission_new" id="new_is_"
                    @if (!$studentAdmissionCheck) checked @endif value="true" disabled>
            ...
            <div class="form-check m-0">
                <input class="form-check-input" type="radio" name="is_admission_new" id="old_student"
                    @if ($studentAdmissionCheck) checked @endif value="false" disabled>
                <label class="form-check-label" for="old_student">Old Student</label>
            </div>
        </div>
        <input type="hidden" name="is_admission_new" value="{{ $studentAdmissionCheck ? 'false' : 'true' }}">
    </div>
    <div class="row mb-3">
        <div class="col">
            <label for="student_id" class="form-label">Student</label>
            <select name="student_id" id="student_id" class="select2 form-select" data-placeholder="Select student">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <select id="gender" class="select2 form-select" data-placeholder="Select gender" disabled>
            ...
            <div class="d-flex gap-3">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_indian_citizen" id="citizen_yes"
                        value="true" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_indian_citizen == true) checked @endif checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_indian_citizen" id="citizen_no"
                        value="false" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_indian_citizen == false) checked @endif>
        ...
        <div class="col">
            ...
            @if ($oldAdmissionDetails && $oldAdmissionDetails->student_photo_url != '')
                <div class="doc-download-box">
                    <a
                        href="{{ route('admission.images.download', ['id' => $oldAdmissionDetails->id, 'fieldName' => 'student_photo_url']) }}"><span>Passport
                            Size Photo</span>
                        <img src="{{ asset('assets/images/download-icon.svg') }}">
                    </a>
                    <img src="{{ asset($oldAdmissionDetails->student_photo_url) }}" alt="" id="studentImg"
                        class="uploaded-img">
                </div>
            @endif
        </div>
    ...
    <div class="row mb-3 adhaar_number_field">
        <div class="col">
            ...
            <input type="number" class="form-control" id="adhaar_number" name="adhaar_number"
                value="{{ $oldAdmissionDetails->adhaar_number ?? '' }}" placeholder="Aadhar Number">
        </div>
        <div class="col">
            ...
            <div class="upload-group">
                <div class="error-message drop-area">
                    <label for="aadhar_front_upload" class="custom-file-upload">
                        <span id="aadhar-front-label"
                            data-default='Aadhar Card Front <i class="las la-plus-circle"></i>'>Aadhar Card Front <i
                    ...
                    <div class="mb-3 d-none" id="aadhar_front_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Aadhar Card Front...</label>
                    </div>
                    <img id="aadhar_frontImage" class="rounded img-fluid" src="" style="display: none;" />
                    @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                        @php
                            $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Aadhar Card Front');
                        @endphp
                        @if ($document)
                            <div class="doc-download-box">
                ...
                <div class="error-message drop-area">
                    <label for="aadhar_back_upload" class="custom-file-upload">
                        <span id="aadhar-back-label"
                            data-default='Aadhar Card Back <i class="las la-plus-circle"></i>'>Aadhar Card Back <i
                                class="las la-plus-circle"></i></span>
                    ...
                    <div class="mb-3 d-none" id="aadhar_back_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Aadhar Card Back...</label>
                    </div>
                    <img id="aadhar_backImage" class="rounded img-fluid" src="" style="display: none;" />
                    @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                        @php
                            $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Aadhar Card Back');
                        @endphp
                        @if ($document)
                            <div class="doc-download-box">
                                <a href="{{ route('admission.document.download', $document->id) }}"><span>Aadhar
    ...
    <div class="row mb-3 passport_number_student_field d-none">
        <div class="col">
            ...
            <input type="text" class="form-control" id="passport_number" name="passport_number"
                value="{{ $oldAdmissionDetails->passport_number ?? '' }}" placeholder="Passport Number">
        </div>
        <div class="col">
            ...
            <div class="upload-group">
                <div class="error-message drop-area">
                    <label for="passport_front_upload" class="custom-file-upload">
                        <span id="passport-front-label"
                            data-default='Passport Front <i class="las la-plus-circle"></i>'>Passport Front <i
                                class="las la-plus-circle"></i></span>
                    ...
                    <div class="mb-3 d-none" id="passport_front_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Passport Front...</label>
                    </div>
                    <img id="passport_frontImage" class="rounded img-fluid" src="" style="display: none;" />
                    @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                        @php
                            $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Passport Front');
                        @endphp
                        @if ($document)
                            <div class="doc-download-box">
                ...
                <div class="error-message drop-area">
                    <label for="passport_back_upload" class="custom-file-upload">
                        <span id="passport-back-label"
                            data-default='Passport Back <i class="las la-plus-circle"></i>'>Passport Back <i
                                class="las la-plus-circle"></i></span>
                        ...
                        <div class="mb-3 d-none" id="passport_back_upload_wrapper"
                            ...
                            <label id="lbUploadedImge" for="">Uploading Passport Back...</label>
                        </div>
                    </label>
                    <img id="passport_backImage" class="rounded img-fluid" src="" style="display: none;" />
                    @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                        @php
                            $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Passport Back');
                        @endphp
                        @if ($document)
                            <div class="doc-download-box">
                                <a href="{{ route('admission.document.download', $document->id) }}"><span>Passport
            ...
            <div class="d-flex gap-3">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_any_illness" id="illness_yes"
                        value="true" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_any_illness == true) checked @endif>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_any_illness" id="illness_no"
                        value="false" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_any_illness == false) checked @endif checked>
    ...
    <div class="row mb-3">
            ...
            <div class="d-flex gap-3">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_used_vehicle" id="vehicle_yes"
                        value="true" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_used_vehicle == true) checked @endif checked>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="is_used_vehicle" id="vehicle_no"
                        value="false" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_used_vehicle == false) checked @endif>
        ...
        <div class="col vehicle_details_field">
            ...
            <input type="text" class="form-control" id="vehicle_number" name="vehicle_number"
                value="{{ $oldAdmissionDetails->vehicle_number ?? '' }}" placeholder="Vehicle Number">
        </div>
    </div>
            ...
            <div class="upload-group">
                <div class="error-message drop-area">
                    <label for="license_upload" class="custom-file-upload">
                        <span id="license-label" data-default='License <i class="las la-plus-circle"></i>'>License <i
                                class="las la-plus-circle"></i></span>
                    ...
                    <div class="mb-3 d-none" id="license_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading License...</label>
                    </div>
                    ...
                    @if ($oldAdmissionDetails && $oldAdmissionDetails->licence_doc_url != '')
                        <div class="doc-download-box">
                            <a
                                href="{{ route('admission.images.download', ['id' => $oldAdmissionDetails->id, 'fieldName' => 'licence_doc_url']) }}"><span>Licence</span>
                                <img src="{{ asset('assets/images/download-icon.svg') }}">
                            </a>
                            <img src="{{ asset($oldAdmissionDetails->licence_doc_url) }}" alt=""
                                id="licenceImg" class="uploaded-img">
                        </div>
                    @endif
                </div>
                <div class="error-message drop-area">
                    <label for="insurance_upload" class="custom-file-upload">
                        <span id="insurance-label"
                            data-default='Insurance <i class="las la-plus-circle"></i>'>Insurance <i
                                class="las la-plus-circle"></i></span>
                    ...
                    <div class="mb-3 d-none" id="insurance_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Insurance...</label>
                    </div>
                    ...
                    @if ($oldAdmissionDetails && $oldAdmissionDetails->insurance_doc_url != '')
                        <div class="doc-download-box">
                            <a
                                href="{{ route('admission.images.download', ['id' => $oldAdmissionDetails->id, 'fieldName' => 'insurance_doc_url']) }}"><span>Insurance</span>
                                <img src="{{ asset('assets/images/download-icon.svg') }}">
                            </a>
                            <img src="{{ asset($oldAdmissionDetails->insurance_doc_url) }}" alt=""
            ...
            <div class="upload-group">
                <div class="error-message drop-area">
                    <label for="rc_front_upload" class="custom-file-upload">
                        <span id="rc-front-label" data-default='RC Book Front <i class="las la-plus-circle"></i>'>RC
                            Book Front <i class="las la-plus-circle"></i>
                        </span>
                    ...
                    <div class="mb-3 d-none" id="rc_front_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading RC Book Front...</label>
                    </div>
                    ...
                    @if ($oldAdmissionDetails && $oldAdmissionDetails->rcbook_front_doc_url != '')
                        <div class="doc-download-box">
                            <a
                                href="{{ route('admission.images.download', ['id' => $oldAdmissionDetails->id, 'fieldName' => 'rcbook_front_doc_url']) }}"><span>RC
                                    Book Front</span>
                                <img src="{{ asset('assets/images/download-icon.svg') }}">
                            </a>
                            <img src="{{ asset($oldAdmissionDetails->rcbook_front_doc_url) }}" alt=""
                ...
                <div class="error-message drop-area">
                    <label for="rc_back_upload" class="custom-file-upload">
                        <span id="rc-back-label" data-default='RC Book Back <i class="las la-plus-circle"></i>'>RC
                            Book Back <i class="las la-plus-circle"></i>
                        </span>
                    ...
                    <div class="mb-3 d-none" id="rc_back_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading RC Book Back...</label>
                    </div>
                    ...
                    @if ($oldAdmissionDetails && $oldAdmissionDetails->rcbook_back_doc_url != '')
                        <div class="doc-download-box">
                            <a
                                href="{{ route('admission.images.download', ['id' => $oldAdmissionDetails->id, 'fieldName' => 'rcbook_back_doc_url']) }}"><span>RC
                                    Book Back</span>
                                <img src="{{ asset('assets/images/download-icon.svg') }}">
                            </a>
                            <img src="{{ asset($oldAdmissionDetails->rcbook_back_doc_url) }}" alt=""
