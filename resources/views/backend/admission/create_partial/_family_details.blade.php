    ...
    <div class="row mb-3">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" name="father_occupation"
                value="{{ $oldAdmissionDetails->father_occupation ?? '' }}" id="father_occupation"
    ...
    <div class="row mb-3">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" name="mother_occupation"
                value="{{ $oldAdmissionDetails->mother_occupation ?? '' }}" id="mother_occupation"
            ...
            <div class="upload-group">
                <div class="error-message drop-area">
                    ...
                    <div class="mb-3 d-none" id="father_photo_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Father’s Photo...</label>
                    </div>
                    ...
                    @if ($oldAdmissionDetails && $oldAdmissionDetails->father_photo_url != '')
                        <div class="doc-download-box">
                            ...
                            <img src="{{ asset($oldAdmissionDetails->father_photo_url) }}" alt=""
                                id="fatherImg" class="uploaded-img">
                        </div>
                    @endif
                </div>
                <div class="error-message drop-area">
                    ...
                    <div class="mb-3 d-none" id="mother_photo_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Mother’s Photo...</label>
                    </div>
                    ...
                    @if ($oldAdmissionDetails && $oldAdmissionDetails->mother_photo_url != '')
                        <div class="doc-download-box">
                            ...
                            <img src="{{ asset($oldAdmissionDetails->mother_photo_url) }}" alt=""
                                id="motherImg" class="uploaded-img">
                        </div>
                    @endif
                </div>
            </div>
            ...
            <div class="d-flex gap-3">
                <div class="form-check m-0">
                    <input class="form-check-input" type="radio" name="is_local_guardian_in_ahmedabad"
                        id="local_guardian_yes" value="true" @if ($oldAdmissionDetails && $oldAdmissionDetails->local_guardian_yes == true) checked @endif>
                    <label class="form-check-label" for="local_guardian_yes">YES</label>
                </div>
                <div class="form-check m-0">
                    <input class="form-check-input" type="radio" name="is_local_guardian_in_ahmedabad"
                        id="local_guardian_no" value="false" @if ($oldAdmissionDetails && $oldAdmissionDetails->local_guardian_yes == false) checked @endif
                        checked>
    ...
    <div class="row mb-3 local_guardian_fields">
        ...
        <div class="col">
            ...
            <input type="text" class="form-control" name="guardian_relation"
                value="{{ $oldAdmissionDetails->guardian_relation ?? '' }}" id="guardian_relation"
            ...
            <div class="d-flex gap-3">
                <div class="form-check m-0">
                    <input class="form-check-input" type="radio" name="is_parent_indian_citizen"
                        id="nationality_indian_yes" value="true" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_parent_indian_citizen == true) checked @endif
                        checked>
                    <label class="form-check-label" for="nationality_indian_yes">YES</label>
                </div>
                <div class="form-check m-0">
                    <input class="form-check-input" type="radio" name="is_parent_indian_citizen"
                        id="nationality_indian_no" value="false" @if ($oldAdmissionDetails && $oldAdmissionDetails->is_parent_indian_citizen == false) checked @endif>
                ...
                <div class="upload-group">
                    <div class="error-message drop-area">
                        ...
                        @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                            @php
                                $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Parent Aadhar Card Front');
                            @endphp
                            @if ($document)
                                <div class="doc-download-box">
                    ...
                    <div class="error-message drop-area">
                        ...
                        <div class="mb-3 d-none" id="parents_aadhar_back_upload_wrapper"
                            ...
                            <label id="lbUploadedImge" for="">Uploading Parent Aadhar Card Back...</label>
                        </div>
                        <img id="parents_aadhar_backImage" class="rounded img-fluid" src=""
                            style="display: none;" />
                        @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                            @php
                                $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Parent Aadhar Card Back');
                            @endphp
                            @if ($document)
                                <div class="doc-download-box">
                                    <a href="{{ route('document.download', $document->id) }}"><span>Aadhar
            ...
            <div class="upload-group">
                <div class="error-message drop-area">
                    ...
                    <div class="mb-3 d-none" id="parents_passport_front_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Parent Passport Front...</label>
                    </div>
                    <img id="parents_passport_frontImage" class="rounded img-fluid" src=""
                        style="display: none;" />
                    @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                        @php
                            $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Parent Passport Front');
                        @endphp
                        @if ($document)
                            <div class="doc-download-box">
                ...
                <div class="error-message drop-area">
                    ...
                    <div class="mb-3 d-none" id="parents_passport_back_upload_wrapper"
                        ...
                        <label id="lbUploadedImge" for="">Uploading Parent Passport Back...</label>
                    </div>
                    <img id="parents_passport_backImage" class="rounded img-fluid" src=""
                        style="display: none;" />
                    @if ($oldAdmissionDetails && $oldAdmissionDocuments)
                        @php
                            $document = $oldAdmissionDocuments->firstWhere('doc_type', 'Parent Passport Back');
                        @endphp
                        @if ($document)
                            <div class="doc-download-box">
                                <a href="{{ route('document.download', $document->id) }}"><span>Passport
