...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between py-3">
            <h5 class="card-title m-0 me-2 text-secondary">Add Village</h5>
        </div>
        <form action="{{ route('village.store') }}" method="post" class="village_form" id="village_create_form">
            @csrf
                    ...
                    <div class="col-sm-6 col-lg-6 mb-4">
                        <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" name="name" value="{{ old('name') }}"
                                id="name" placeholder="Enter village name" required
