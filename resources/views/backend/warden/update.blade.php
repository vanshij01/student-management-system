...
@section('content')
    <div class="card">
        <div class="card-header text-white py-3">
            <h5 class="card-title m-0 me-2 text-light">Update Warden</h5>
        </div>
        <form action="{{ route('warden.update', $warden->id) }}" method="post" class="warden_form">
            @csrf
            @method('PUT')
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="first_name"
                            value="{{ old('first_name', $warden->first_name) }}" id="first_name"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="last_name"
                            value="{{ old('last_name', $warden->last_name) }}" id="last_name" placeholder="Enter last name"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="email" class="form-control" name="email" value="{{ old('email', $warden->email) }}"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="number" class="form-control" name="phone" value="{{ old('phone', $warden->phone) }}"
                            id="phone" placeholder="Enter mobile number" min="0" minlength="7" required
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="dob"
                            value="{{ date('d/m/Y', old(strtotime('dob'), strtotime($warden->dob))) }}"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <select name="gender" id="gender" class="select2 form-select" data-placeholder="Select gender"
                            ...
                            <option @if (old('gender', $warden->gender) == 'male') selected @endif value="male" selected>Male
                            </option>
                            <option @if (old('gender', $warden->gender) == 'female') selected @endif value="female">Female
                            </option>
                        </select>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <textarea class="form-control" name="address" id="address" placeholder="Enter address" required
                            data-parsley-required-message="The address field is required.">{{ old('address', $warden->address) }}</textarea>
                        @error('address')
                            <small class="red-text ml-10" role="alert">
                                {{ $message }}
                            </small>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="experience"
                            value="{{ old('experience', $warden->experience) }}" id="experience"
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" name="qualification"
                            value="{{ old('qualification', $warden->qualification) }}" id="qualification"
                            placeholder="Enter qualification" required
                            data-parsley-required-message="The qualification field is required." />
                        @error('qualification')
                            <small class="red-text ml-10" role="alert">
                                {{ $message }}
                            </small>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        ...
                        <select name="status" id="status" class="select2 form-select"
                            ...
                            <option @if (old('status', $warden->status) == '1') selected @endif value="1" selected>
                                Enable
                            </option>
                            <option @if (old('status', $warden->status) == '0') selected @endif value="0">Disable
                            </option>
                        </select>
