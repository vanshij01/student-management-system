...
@section('content')
    <div class="card mb-2">
        <div class="card-header d-md-flex d-sm-block align-items-center justify-content-between py-md-2">
            <h5 class="card-title m-0 me-2 text-white d-none d-md-block">View Bed Details</h5>
            <h3 class="card-title m-0 me-2 text-white d-block d-md-none">View Bed Details</h3>

            <div class="d-flex gap-2 mt-4 mt-md-0">
                <button type="button" class="btn secondary_btn back">Back</button>
                <button type="button" class="btn secondary_btn edit" data-id="{{ $bed->id }}">Update</button>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-4 col-md-4 col-12 border-right">
                    <h6>Bed Number</h6>
                    <label>{{ $bed->bed_number }}</label>
                </div>
                <hr class="responsive_hr my-1">
                <div class="col-lg-4 col-md-4 col-12 border-right">
                    <h6>Hostel Name</h6>
                    <label>{{ $bed->hostel->hostel_name }}</label>
                </div>
                <hr class="responsive_hr my-1">
                <div class="col-lg-4 col-md-4 col-12">
                    <h6>Status</h6>
                    <label>{{ $bed->status == 1 ? 'Enabled' : 'Disabled' }}</label>
                </div>
            </div>
        </div>
    </div>
