...
@section('title', 'Available Beds Listing')
@section('styles')
@endsection
@section('content')
    <div class="dashboard-header-container">
        <div class="d-flex d-board-inr">
            ...
            <h3 class="dashboard-header">Available Beds</h3>
        </div>
    </div>
    <form>
    ...
    <div class="table_content_wrapper">
        <div class="data_table_wrap">
            <table id="available_beds_table" class="table table-bordered align-middle" style="width: 100%">
...
@endsection
@section('scripts')
    <script src="{{ asset('js/report/available_beds.js') }}"></script>
@endsection
