    ...
    <section class="Personal_details_form">
        <div class="container">
            ...
            <div id="admission_form" class="bs-stepper mt-2">
                <form action="{{ route('student.admission.update', $admissionDetail->id) }}" method="post"
                    enctype="multipart/form-data" id="admission_form">
                    @csrf
                    @method('PUT')
                    <input type="hidden" id="form_mode" name="form_mode" value="update">
                    <input type="hidden" value="{{ $admissionDetail->id }}" id="student_id">
                    ...
                    <div class="bs-stepper-content p-0">
                        <!-- personal Details -->
                        @include('frontend.admission.update_partial._personal_details')
                        <!-- family-details -->
                        @include('frontend.admission.update_partial._family_details')
                        <!-- education-details -->
                        @include('frontend.admission.update_partial._education_details')
                        <!-- declaration -->
                        @include('frontend.admission.update_partial._declaration')
                    </div>
                </form>
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/admission/admission_frontend_update.js') }}"></script>
